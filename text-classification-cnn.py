...
def build_model(embedding_matrix):
    ...
    x1 = Conv1D(conv_size, 5, activation='relu', padding='same')(x)
    x1 = MaxPooling1D(10, padding='same')(x1)
    x2 = Conv1D(conv_size, 4, activation='relu', padding='same')(x)
    x2 = MaxPooling1D(10, padding='same')(x2)
    x3 = Conv1D(conv_size, 3, activation='relu', padding='same')(x)
    x3 = MaxPooling1D(10, padding='same')(x3)
